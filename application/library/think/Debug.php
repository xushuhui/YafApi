...
class Debug
{
    ...
    {
        $str = '<pre style="display: block;padding: 9.5px;margin: 44px 0 0 0;font-size: 20px;line-height: 1.42857;
                color: red;word-break: break-all;word-wrap: break-word;background-color: #F5F5F5;
                border: 1px solid #CCC;border-radius: 4px;">';
        if (is_bool($var))
        {
            $show_data            = $var ? 'true': 'false';
        }elseif (is_null($var)) {
            $show_data            = 'null';
        }
        elseif ($var == ''){
